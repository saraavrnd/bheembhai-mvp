...
4. **Self-check** against `references/prd-quality-checklist.md`. Fix anything that fails.
   ...
   it.
5. **Write `PRD.md`** to the location given for the PRD in the Project Layout table in `CLAUDE.md`
   (current layout: `docs/product/PRD.md`). If no repo/CLAUDE.md exists yet — i.e. the PRD is
